...
import Services, { IOrdemProducaoTable } from "./services";
...
function OrdensPage() {
  ...
  const handleCreateOrdem = async (values: any) => {
    ...
    console.log(values);
    setLoading(true);
    var req: IOrdemProducao = {
      numeroOrdemProducao: values.numeroOrdemProducao,
  ...
  const confirm = (data: IOrdemProducaoTable) => {
    Modal.confirm({
      title: "Excluir",
  ...
  const columns: ColumnsType<IOrdemProducaoTable> = [
    {
      title: "ID",
      dataIndex: "id",
      key: "id",
